...
*/
define(['app', '../../common/services/serviceProvider', '../../acquire/services/dataSourceConfigurationManager'], function(app) {
    app.factory('DataSourceUtils', ['ServiceProvider', 'DataSourceConfigurationManager', '$http', '$rootScope',
        function(ServiceProvider, DataSourceConfigurationManager, $http, $rootScope) {
