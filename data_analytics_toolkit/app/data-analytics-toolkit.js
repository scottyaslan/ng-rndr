...
*    along with this program.  If not, see <http://www.gnu.org/licenses/agpl.html>.
*/
define('controllers/DATController',[], function() {
    'use strict';

    function DATController(ServiceProvider, RenderingEngineManager, UiControls, DataSourceConfigurationManager, Renderers, $window, $rootScope, $timeout, $http, $location, $scope) {
    ...
    DATController.$inject=['ServiceProvider', 'RenderingEngineManager', 'UiControls', 'DataSourceConfigurationManager', 'Renderers', '$window', '$rootScope', '$timeout', '$http', '$location', '$scope'];

    return DATController;
});
/*   Data Analytics Toolkit: Explore any data avaialable through a REST service 
*    Copyright (C) 2016  Scott Aslan
*
...
*    along with this program.  If not, see <http://www.gnu.org/licenses/agpl.html>.
*/
define('directives/datDirective',[], function() {
    'use strict';
...
*    along with this program.  If not, see <http://www.gnu.org/licenses/agpl.html>.
*/
define('data-analytics-toolkit-angular-module',['config',
