...
require.config({
    ...
    paths: {
        ...
        'TheApp': 'requirejs-sample-app',
        'data-analytics-toolkit': 'data-analytics-toolkit',
    ...
    shim: {
        ...
        'gridster': ['jquery'],
        'c3': ['d3'],
        'controllers/../../../render/plugins/dist/gchart_renderers.min': ['goog!visualization,1,packages:[charteditor]'],
        'controllers/../../../render/plugins/dist/c3_renderers.min': ['c3'],
        'controllers/../../../render/plugins/dist/d3_renderers.min': ['d3'],
        'controllers/../../../render/plugins/dist/datatables_renderers.min': ['datatables.net', 'datatables.net-keytable', 'datatables.net-fixedcolumns', 'datatables.net-buttons-html5', 'datatables.net-buttons-print'], 
        ...
        'data-analytics-toolkit': ['angular', 'angular-route', 'angular-material', 'angular-resource', 'angular-local-storage', 'parallax', 'bower_components/angularContextMenu/src/angular-contextMenu', 'controllers/../../../render/plugins/dist/gchart_renderers.min', 'datatables.net', 'gridster', 'bower_components/angular-ui-sortable/sortable', 'bower_components/angular-ui-ace/ui-ace']
    },
    deps: ['TheApp']
});