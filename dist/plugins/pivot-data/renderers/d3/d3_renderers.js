(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery', 'd3'], function($, d3) {
            return (root.ngRndr.plugins.pivotData.renderers['d3'] = factory($, d3));
        });
    } else if (typeof module === 'object' && module.exports) {
        module.exports = (root.ngRndr.plugins.pivotData.renderers['d3'] = factory(require('jquery'), require('d3')));
    } else {
        root.ngRndr.plugins.pivotData.renderers['d3'] = factory(root.$, root.d3);
    }
}(this, function($, d3) {
    return {
