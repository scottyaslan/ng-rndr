(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery'], function($) {
            return (root.ngRndr.plugins.pivotData.renderers['datatables'] = factory($));
        });
    } else if (typeof module === 'object' && module.exports) {
        module.exports = (root.ngRndr.plugins.pivotData.renderers['datatables'] = factory(require('jquery')));
    } else {
        root.ngRndr.plugins.pivotData.renderers['datatables'] = factory(root.$);
    }
}(this, function($) {
    ...
    return {
        'DataTable': function(renderingEngine, opts) {
            return finalize(datatable(renderingEngine, opts), opts);
        },
        'DataTable Barchart': function(renderingEngine, opts) {
