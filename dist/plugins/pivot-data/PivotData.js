...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery'], function($) {
            return (root.ngRndr.plugins.DataViews['PivotData'] = factory($));
        });
    } else if (typeof module === 'object' && module.exports) {
        module.exports = (root.ngRndr.plugins.DataViews['PivotData'] = factory(require('jquery')));
    } else {
        root.ngRndr.plugins.DataViews['PivotData'] = factory(root.$);
    }
}(this, function($) {
