(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery'], function($) {
            return (root.ngRndr.plugins.renderers['gchart'] = factory($));
        });
    } else if (typeof module === 'object' && module.exports) {
        module.exports = (root.ngRndr.plugins.renderers['gchart'] = factory(require('jquery')));
    } else {
        root.ngRndr.plugins.renderers['gchart'] = factory(root.$);
    }
}(this, function($) {
