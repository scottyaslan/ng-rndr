(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery', 'c3'], function($, c3) {
            return (root.ngRndr.plugins.renderers['c3'] = factory($, c3));
        });
    } else if (typeof module === 'object' && module.exports) {
        module.exports = (root.ngRndr.plugins.renderers['c3'] = factory(require('jquery'), require('c3')));
    } else {
        root.ngRndr.plugins.renderers['c3'] = factory(root.$, root.c3);
    }
}(this, function($, c3) {
