(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery'], function($) {
            return (root.ngRndr.plugins.pivotData.renderers['pivottables'] = factory($));
        });
    } else if (typeof module === 'object' && module.exports) {
        module.exports = (root.ngRndr.plugins.pivotData.renderers['pivottables'] = factory(require('jquery')));
    } else {
        root.ngRndr.plugins.pivotData.renderers['pivottables'] = factory(root.$);
    }
}(this, function($) {
