...
define(['app', '../../common/services/serviceProvider', '../../common/services/uiControls'], function(app) {
    app.factory('DashboardFactory', ['$rootScope', '$compile', '$window', 'ServiceProvider', 'UiControls', '$q', '$timeout',
        function($rootScope, $compile, $window, ServiceProvider, UiControls, $q, $timeout) {
